...
\subsection*{Validating the model with in-sample and out-of-sample tests}
...
The performances of models were evaluated with AUC \josh{AUC}{can we add these values?} \citep{jimenez2012insights}. 
