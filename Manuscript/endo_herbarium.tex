...
We also found that changes in prevalence were associated with observed changes in seasonal climate drivers; noteably increasing precipitation corresponding to each host species' peak growing season and changes in off-peak season variability in precipitation. 
...
The following analyses used the liberal status, but we repeated all analyses with the conservative status which yielded qualitatively similar results (Fig. \ref{fig:FigA5})
...
%\tom{surveys of \emph{A. hyemalis} took place between 2015 and 2020}{We have added more recent AGHY survey data. I am not sure if you have access to this but you should definitely use it. Karl or I can point you to the right file.}.
