...
}{Volker's suggestions included moving all material specific to study system into methods, but it seems a bit difficult to do.}
...
We first address questions describing spatial and temporal trends in endophyte prevalence: (i) How has endophyte prevalence changed over time? and (ii) How spatially heterogenous are temporal trends in endophyte prevalence?
We then address how climate change may be driving these trends in endophyte prevalence by asking: (iii) What is the relationship between variation in temporal trends in endophyte prevalence and changes in climate drivers?
We examined 2,346 specimens collected across across eastern North America between 1824 and 2019.
...
We evaluated the predictive ability of the model using contemporary endophyte surveys as out-of-sample test data, an important but rarely used strategy in ecological studies \cite{tredennick2021practical}. 
We used data from contemporary surveys of endophyte prevalence  in \emph{A. hyemalis} and \emph{E. virginicus}. 
...
}{considering dropping this section because the model does a good job at predicting the mean regional prevalenece, but has way less variability that the contemporary surveys}
