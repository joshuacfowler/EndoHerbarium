...
\linelabel{R1C7-begin}
First and foremost, this is \revise{one of a growing number of studies to examine microbial symbiosis using specimens from natural history collections, and the first, to our knowledge, to link long-term changes in the symbioses to changes in climate.}\linelabel{R1C7-end}
