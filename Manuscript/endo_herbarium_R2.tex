...
\linelabel{R4C10-begin}Natural history specimens, which were originally collected to document and preserve taxonomic diversity, present a unique opportunity to explore long-term changes in \revise{biodiversity} and ecological interactions across broad spatial and temporal scales\revise{ \citep{meineke2018unrealized, davis2023herbarium}.}
...
These specimens often preserve physical legacies of ecological processes and species' interactions from dynamically changing environments across time and space \revise{\citep{lendemer2020extended}.}\linelabel{R4C10-end}
...
\linelabel{R4C11a-begin}\revise{Herbarium specimens have also been used to identify the origins and population genomics of  plant diseases such as \emph{Phytophora}, the Irish potato famine pathogen \citep{ristaino2001pcr,ristaino2002tracking,yoshida2013rise}, and have been proposed as vehicles to track other emerging plant pathogens \citep{ristaino2020importance,bradshaw2021global}.}\linelabel{R4C11a-end}
However, few previous studies have leveraged biological collections to examine climate change-related shifts in a particularly common type of interaction: \revise{mutualistic} microbial symbiosis.
...
\revise{The identity of each specimen collector was gathered as part of the sample's metadata.}
...
\revise{We recorded the identity of ech scorer as part of the data collection process.}
...
We tested a range of values (from $68$ kilometers to $1714$ kilometers) and meshes (presented in the Supporting Methods \revise{-- \emph{Mesh and Prior Sensitivity Analysis}}), finding that while the magnitude and uncertainty of effects varied, model results were qualitatively similar, i.e. the same direction of effects across space.
...
This result aligns with the species' autumn active growing season, however other seasonal climate drivers were also \revise{positively} associated with increasing endophyte prevalence in this host species. 
...
\revise{Across the tested climate drivers}, increases in mean spring precipitation were the strongest predictor of increasing trends in endophyte prevalence for \emph{A. hyemalis} (Fig. \ref{fig:climate_correlation_plot}B) (greater than $99$\% posterior probability of a positive slope).
...
\firstrevise{Broad changes in the distribution and abundance of natural enemies \cite{cote2004ecological}, along with stresses from anthropogenic changes in \linelabel{R3C7-begin}\revise{land management} and pollution \cite{sage2020global} likely influence the benefits of symbiosis \cite{rudgers2020climate}.}
\revise{Changing endophyte prevalence} results from the combination of \revise{net} fitness benefits playing out across the heterogeneous map of a changing climate and \linelabel{R3C8-begin}\revise{and its interactive effects on} other anthropogenic drivers.\linelabel{R2C44-end}\linelabel{R3C8-end}
\revise{Host species experience a world that is made increasingly stressful by a combination of global change drivers, and while historic trends that we observed suggest that symbiotic fitness benefits have helped mitigate this stress, it is possible that at yet higher levels of stress, increasing costs of the mutualism could lead to declines in endophyte prevalence. 
...
\linelabel{R1C11-b-begin}However, symbiont-facilitated range shifts require that endophytes be present in the populations to be able to \revise{contribute to} population growth. 
For example, the arid western range edge of \emph{A. hyemalis} has had historically low endophyte prevalence (Fig. \ref{fig:svc_space_year_map}), and while prevalence has increased most quickly in regions with historically low endophyte prevalence (Fig. \ref{fig:initialprev_trend_plot}), the complete absence of endophytes at range edges in this species would make it impossible for prevalence to increase without dispersal of symbiotic seeds \cite{fowler2023geographic}.\linelabel{R1C11-b-end}
...
\linelabel{R4C10b-begin} \revise{Herbarium collections were predominately used for taxonomic research in the past, but use of specimens to understand ongoing global change would benefit from increased collection efforts and expansion of herbarium collections.} \linelabel{R4C10b-end}
\linelabel{R3C6-begin}\revise{An alternative validation test would be to hold-out samples from the historic data set. Such a test would more clearly match the conditions of the training data (i.e., in spatial scale and climate conditions), however the trade-off between training and testing the model with a limited number of sampled specimens held us back from exploring this option. 
...
\linelabel{R3C3b-begin}\revise{Another key consideration in forecasting the dynamics of host-microbe symbioses is the spatial scale of both specimen georeferencing and available climate data. 
...
\linelabel{R3C5-begin}\revise{Local adaptation in either the host or symbiont to microclimate or soil conditions could cause populations to differ from broad regional trends.}\linelabel{R3C5-end}
\linelabel{R3C2c-begin}\revise{The choice of prior distributions for spatially-varying random effects also impacts the model's flexibility to capture spatial trends. 
...
\linelabel{R4C11b-begin}\revise{Much of this work highlights the important role that historic specimens can play in tracking pathogens, a particularly important area as climate change facilitates the spread of new diseases \cite{ristaino2020importance,singh2023climate}}\linelabel{R4C11b-end}
...
\linelabel{R4C10c-begin}\revise{Natural history specimens, such as the plant hosts examined in this study, have a clear role to play in informing global change biodiversity science, including building understanding of the dynamics of host-symbiont interactions \cite{davis2023herbarium}.}\linelabel{R4C10c-end}\
...
The ``time machine'' of natural history collections revealed evidence of mutualism resilience for grass-endophyte symbioses in the face of environmental change, but more extreme changes could potentially push one or both partners beyond their physiological limits, leading to the collapse of the mutualism; more research is needed to understand what those limits might be. 
	...
	\revise{Four} anonymous reviewers greatly improved earlier versions of this manuscript.
