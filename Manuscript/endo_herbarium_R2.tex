...
\revise{Host species experience a world that is made increasingly stressful by the combination of these global change drivers, and while historic trends that we observed suggest that symbiotic fitness benefits have helped mitigate this stress, it is likely that at some higher leveler of stress, increasing costs of maintaining the mutualism could lead to declines in endophyte prevalence.}\linelabel{R3C7-end}
...
Another interesting question is the degree to which symbiotic and non-symbiotic hosts, which occupy overlapping but distinct niches, are likely to experience distribution shifts in tandem or at different rates in future.\linelabel{R2C42-end}
...
The past indicates a resilient symbiosis, but it will be crucial to understand whether more extreme future climate conditions could tip this interaction to deteriorate.}\linelabel{R2C14-end}
...
\linelabel{R3C6-begin}\revise{An alternative validation test would be to hold-out samples from within the historic data set. Such a test would more clearly provide a set of data that matched the conditions of the training data (i.e in spatial scale and climate conditions) missing within the contemporary test data, however a relatively limited number of sampled specimens held us back from exploring this option. 
...
\linelabel{R4C10b-begin}From a modeler's perspective, this also urges advocacy for increased collection efforts and expansion of herbarium collections.}\linelabel{R3C6-end}\linelabel{R4C10b-end}
...
\linelabel{R3C5-begin}\revise{Another interesting question is whether local adaption, in either host or symbiont may influence future range shifts.}\linelabel{R3C5-end}
