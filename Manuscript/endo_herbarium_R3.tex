...
\emph{Epichloë} fungal endophytes are specialized symbionts of cool-season grasses, \linelabel{R5C7-begin-dubious}\revise{estimated from surveys to associate with $\sim 20 - 30$\%} of species \revise{in the diverse Poaceae family} \citep{leuchtmann1992systematics}. \revise{Surveys within the cool-season grass subfamily (Pooideae) have found that associations occur for between ~17\% to ~40\% of sampled species \cite{iannone2011diversity,card2014mutualistic}}. \linelabel{R5C7-end-dubious}
\tom{}{I have not made any edits here but I find it a little confusing to provide to sets of estimates for endophyte prevalence, one from Poaceae and one from Pooideae. Maybe that's just a me thing and not worth changing.}
...
In line with this, monitoring of long-term plots of \emph{A. perennans} and \emph{E. virginicus} showed no production of stromata on \emph{A. perennans} and on only less than 1\% of \emph{E. virginicus} plants over 14 years \cite{fowler2024microbial}}.\linelabel{R5C3-end}
...
\linelabel{R5C5-begin}\revise{\tom{It is also know that stressful conditions can reduce the rate of successful transmission of \emph{Epichloë}}{I think this statement is too strong given that there is also evidence that stress promotes transmission -- see Pedro Gundel's paper on Poa autumnalis.} endophytes from mother plant to offspring \cite{gundel2011neotyphodium}, a likely consequences of host sanctions on costly symbionts or symbiont failure to successfully colonize seeds \cite{afkhami2008symbiosis,gundel2011incorporating}. 
...
\revise{A range edge population with no endophytes would require dispersal of symbionts to occur, either via symbiotic seeds or \linelabel{R5C5-discussion-begin} horizontally-transmitted fungal spores, before the symbiosis could result in an expanding distibution \cite{fowler2023geographic}}\linelabel{R5C5-discussion-end} 
